...
const signalBars = [10, 12, 14, 16];

export default function GamificationSection({ onCTA }: GamificationSectionProps) {
  return (
      ...
      <div className="container">
        <div className="gami-grid reveal" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 72, alignItems: "center" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            <div style={{ fontFamily: "var(--font-interface)", fontSize: 11, fontWeight: 500, letterSpacing: "0.10em", textTransform: "uppercase", color: "var(--color-amber)" }}>
              Gamificação
            </div>
          ...
          <div className="phone-side reveal reveal-delay-1" style={{ display: "flex", justifyContent: "center" }}>
            <div style={{ width: 256, borderRadius: 34, background: "var(--color-base)", border: "6px solid rgba(255,255,255,0.10)", boxShadow: "var(--glow-amber), var(--shadow-elevated), 0 0 0 1px rgba(255,178,58,0.15)", overflow: "hidden" }}>
              ...
              {/* Phone content */}
              <div style={{ background: "var(--color-base)", padding: 14, display: "flex", flexDirection: "column", gap: 11 }}>
                {/* Header */}
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <Image src="/nutrk-logo.svg" alt="Nūtrk" width={60} height={13} style={{ height: 13, width: "auto" }} />
                ...
                <div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                    {phoneItems.map(({ label, icon, done }) => (
